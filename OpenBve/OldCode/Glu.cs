/*
 *  This is a port of the "project.c" file from the SGI OpenGL sample implementation.
 *  It can be found at http://oss.sgi.com/projects/ogl-sample/
 *  Check original for license, if that matters. Its very liberal, though.
 *  Some functions were removed, some are added.
 * 	The ray intersection test is taken from Dan Sunday's implementation that he shows
 *  at http://softsurfer.com/Archive/algorithm_0105/algorithm_0105.htm
 * 
*/
